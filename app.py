...
if not st.session_state["usuario_activo"]:
    st.markdown(
        ...
        '.lrow img.atlas{height:36px;object-fit:contain;}'
        '.lrow img.centi{height:52px;object-fit:contain;}'
        '.lsep{width:1px;height:40px;background:rgba(255,255,255,0.15);}'
