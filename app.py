...
if not st.session_state["usuario_activo"]:
    st.markdown(
        ...
        '.lrow{display:flex;justify-content:center;align-items:center;gap:18px;margin-bottom:1.6rem;}'
        '.lrow img{height:38px;object-fit:contain;}'
        '.lsep{width:1px;height:34px;background:rgba(255,255,255,0.15);}'
        '.ltitle{font-family:Rajdhani,sans-serif;font-size:2.5rem;font-weight:700;color:#fff;text-align:center;letter-spacing:0.1em;text-shadow:0 0 40px rgba(0,160,198,0.6);margin-bottom:0.2rem;}'
    ...
    with col_c:
        st.markdown(
            ...
            "<div class='lsep'></div>"
            "<img src='data:image/png;base64,' alt='Centinela'>"
            "</div>"
